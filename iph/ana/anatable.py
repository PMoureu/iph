...
'method_descriptor':{'icon': 'function',
              'category' : 'function',
             'members' : None,
             'value' : get_std_value,
             'doc' : get_doc
...
'builtin_function_or_method':{'icon': 'function',
              'category' : 'function',
             'members' : None,
             'value' : get_std_value,
             'doc' : get_doc
...
'GenericBuiltinFunction':{'icon': 'function',
              'category' : 'function',
             'members' : None,
             'value' : get_std_value,
             'doc' : get_doc
